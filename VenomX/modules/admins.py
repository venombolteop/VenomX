...
from VenomX.utils.misc import extract_user, extract_user_and_reason, list_admins
...
add_command_help(
     "admin",
     [
         [f"{cmd}ban <reply/username/userid> <reason>", "Banned member from group."],
         [
             f"{cmd}unban <reply/username/userid> <reason>",
             "Unbanned members of the group.",
         ],
         [f"{cmd}kick <reply/username/userid>", "Remove user from group."],
         [
             f"{cmd}promote or {cmd}fullpromote",
             "Promote members as admin or cofounder.",
         ],
         [f"{cmd}demote", "Remove admin as member."],
         [
             f"{cmd}mute <reply/username/userid>",
             "Mute members from Group.",
         ],
         [
             f"{cmd}unmute <reply/username/userid>",
             "Unmuting members of the Group.",
         ],
         [
             f"{cmd}pin <reply>",
         ...
         [
             f"{cmd}setgpic <reply to photo>",
             "To change group profile photo",
         ],
     ],
)