...
from VenomX.helpers.constants import MEMES
...
async def gkahgagw(client: Client, message: Message):
    ...
    animation_chars = [
        ...
        "⬜⬜⬛⬜⬜\n⬜⬛⬜⬜⬜\n🔴⬜⬜⬜⬜",
        "🔴⬛⬛⬜⬜\n⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜",
        "⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜\n⬜  [VENOM IS BEST](https://github.com/venombolteop/VenomX) ⬜\n⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜",
    ]
    if message.forward_from:
        return
...
@Client.on_message(filters.command(["shk", "shake"], cmd) & filters.me)
...
async def hak(client: Client, message: Message):
    ...
    await asyncio.sleep(2)
    await message.edit_text(
        "Targeted Account Hacked...!\n\n ✅ File has been successfully uploaded to my server.\nTelegram Database:\n`./DOWNLOADS/hacked.files`"
    )


@Client.on_message(filters.command(["lumd", "loda"], cmd) & filters.me)
async def lumd(client: Client, message: Message):
...
async def tits(client: Client, message: Message):
    emoji = get_text(message)
    titid = MEMES.TITS
    if emoji:
...
async def adadino(client: Client, message: Message):
    ...
    await typew.edit("`🏃     🦖`")
    await typew.edit("`🏃    🦖`")
    await typew.edit("`Just surrender`")
    await asyncio.sleep(1)
    await typew.edit("`🧎🦖`")
    await asyncio.sleep(2)
...
@Client.on_message(filters.command(["lobe", "lve"], cmd) & filters.me)
...
async def menggabut(client: Client, message: Message):
    e = await edit_or_reply(message, "`HAVE YOU EVER THOUGHT`")
    await e.edit("`WHAT KKKKKK LOVE LOOKS LIKE`")
    await e.edit("`COLORFUL HAIR`")
    await e.edit("`LIKE BALLS`")
    await e.edit("`VERY FUNNY`")
    await e.edit("`ALTHOUGH IT'S NOT TOO HIGH`")
    await e.edit("`EMMMM FUCK IT`")
    await e.edit("`JOINED WOW JOIN`")
    await e.edit("🙈🙈🙈🙈")
    await e.edit("🙉🙉🙉🙉")
    await e.edit("🙈🙈🙈🙈")
    await e.edit("🙉🙉🙉🙉")
    await e.edit("`CHEEK BOOM`")
    await e.edit("🙉🙉🙉🙉")
    await e.edit("🐢                       🚶")
    await e.edit("🐢                      🚶")
    await e.edit("🐢                     🚶")
...
@Client.on_message(filters.command("bye", cmd) & filters.me)
...
@Client.on_message(filters.command("pig", cmd) & filters.me)
async def pig(client: Client, message: Message):
    await edit_or_reply(
        message,
        "┈┈┏━╮╭━┓┈╭━━━━╮\n"
        "┈┈┃┏┗┛┓┃╭┫Nope ┃\n"
...
@Client.on_message(filters.command(["dogs", "dog"], cmd) & filters.me)
...
@Client.on_message(filters.command("now", cmd) & filters.me)
async def nowlove(client: Client, message: Message):
...
@Client.on_message(filters.command("magic", cmd) & filters.me)
async def santet(client: Client, message: Message):
    typew = await edit_or_reply(message, "`Activate Magic Commands....`")
    await asyncio.sleep(2)
    await typew.edit("`Search for This Person's Name...`")
    await asyncio.sleep(1)
    await typew.edit("`Magic Will Be Done Immediately`")
    await asyncio.sleep(1)
    await typew.edit("0%")
    number = 1
...
add_command_help(
     "animation",
     [
         ["fuck", "To show middle finger animation."],
         ["dino", "To display an animation of being chased by a dino."],
         ["magic", "To display an online magic animation."],
         ["flirt", "To display the flirting animation."],
         ["lobe", "To display the lobe animation."],
         ["hack", "To display a fake hacking animation."],
         ["bomb", "To display the Bomb animation."],
         ["brain", "To display the Brain 🧠 animation."],
         ["lumd", "To display lumd art."],
         ["penis", "To display penis art with emoji."],
         ["shoot", "To display the art of shooting."],
         ["bye", "To display bye art."],
         ["helicopter", "To display helicopter art."],
         ["y", "To display art yeah."],
         ["awk", "To display art awkowkowk."],
         ["now", "To show art love."],
         ["dog", "To display dog art."],
         ["pig", "To display pig art."],
