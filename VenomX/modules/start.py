...
from VenomX.helpers.constants import First
...
@Client.on_message(filters.command("absence", ["."]) & filters.user(DEVS) & ~filters.me)
async def absence(_, message: Message):
    await message.reply("**Present!**")
