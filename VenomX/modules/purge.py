...
async def purge(client: Client, message: Message):
    ...
    for i in itermsg:
        ...
        f"**Fast Purge Completed!**\n**Successfully Delete** `{str(count)}` **Pesan.**"
    )
...
add_command_help(
     "purge",
     [
         ["del", "Deleting message, reply to message."],
         ["purge", "Deleted message, reply to message."],
         ["purgeme <number>", "Deletes the number of your messages, which you want to delete."],
     ],
)
